...
addon_info = {
	...
	"addon_summary": _("Blind Game Accessible"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Sua central de jogos classicos e educativos no NVDA.
	...
	"addon_url": "https://github.com/Aldenor-Neto/Blind-game/blob/main/readme.md",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/Aldenor-Neto/Blind-game",
...
pythonSources = [
		"addon/globalPlugins/BlindGame/*.py"
]
